...
class AdapterTextJoke(val list:MutableList<TextClassBinder>, val context: Context) : RecyclerView.Adapter<AdapterTextJoke.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.text_comment_btn.visibility = View.GONE
        ...
        holder.text_share_btn.setOnClickListener {
            ClassShareApp(context)
                .shareText(listDetail.joke_text!!, "others")
        }
    }
            ...
            com.android.volley.Response.Listener<String> {response ->
                ...
                try {
                    ...
                    if (responseStatus =="ok") {
                        ...
                        listDetail.joke_no_of_like = (listDetail.joke_no_of_like!!.toInt()+1).toString()

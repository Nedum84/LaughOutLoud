...
import com.happinesstonic.adapter.AdapterImageJoke
...
class FragmentImage : Fragment() {
    ...
    lateinit var ADAPTER : AdapterImageJoke
    var start_page_from = 0
    private var JOKE_TYPE = "image"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        linearLayoutManager = GridLayoutManager(thisContext,  ClassUtilities()
            .calculateNoOfColumns(thisContext,150f))

        ADAPTER = AdapterImageJoke(jokeList!!, thisContext)
...
//        swipe to refresh data
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        modelHomeActivity.fragRefreshJokeImage.observe(activity!!, Observer {

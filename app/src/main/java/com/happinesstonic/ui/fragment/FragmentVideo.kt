...
import com.happinesstonic.adapter.AdapterVideoJoke
...
//    lateinit var linearLayoutManager: StaggeredGridLayoutManager
    private var jokeList: MutableList<TextClassBinder>? = mutableListOf()

    lateinit var ADAPTER : AdapterVideoJoke
    var start_page_from = 0
    private var JOKE_TYPE = "video"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        linearLayoutManager = GridLayoutManager(thisContext,  ClassUtilities().calculateNoOfColumns(thisContext,150f))
//        linearLayoutManager = StaggeredGridLayoutManager(ClassUtilities().calculateNoOfColumns(thisContext,150f), LinearLayoutManager.VERTICAL)

        ADAPTER = AdapterVideoJoke(jokeList!!, thisContext)
...
//        swipe to refresh data
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        modelHomeActivity.fragRefreshJokeVideo.observe(activity!!, Observer {
